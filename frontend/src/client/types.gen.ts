...
export type AIAlgorithm = 'random' | 'alphabeta' | 'montecarlo';
...
export type GameCreate = {
    player_black_id?: (string | null);
    bot_black_config?: ((ConfigAlphaBeta | ConfigMonteCarlo | ConfigRandom) | null);
    player_white_id?: (string | null);
    bot_white_config?: ((ConfigAlphaBeta | ConfigMonteCarlo | ConfigRandom) | null);
};
...
export type SimulationRequest = {
    num_games?: number;
    bot_black: (ConfigAlphaBeta | ConfigMonteCarlo | ConfigRandom);
    bot_white: (ConfigAlphaBeta | ConfigMonteCarlo | ConfigRandom);
};
